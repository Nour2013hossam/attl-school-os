   ...
   <div className="mt-5 space-y-2">
    {filtered.map(user=><article key={user.id} className="rounded-[20px] border border-black/[.04] bg-white/60 p-4">
      <div className="grid gap-4 lg:grid-cols-[1.4fr_.7fr_.5fr_.7fr] lg:items-center">
       ...
       <div className="flex flex-wrap gap-2"><span className={user.isActive?"rounded-full bg-green-500/10 px-3 py-2 text-center text-[8px] font-semibold text-green-600":"rounded-full bg-black/[.04] px-3 py-2 text-center text-[8px] text-black/35"}>{user.isActive?"Active":"Disabled"}</span>
