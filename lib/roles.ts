...
export const PERMISSION_MATRIX: Record<string, string[]> = {
  ...
  ADMIN: ["admin.access", "school.manage", "files:*", "xp.manage", "users:*", "roles:*", "permissions:*", "results:*", "academics:*", "learning:*", "skills:read", "attl:*", "projects:*", "competitions:*", "events:*", "innovation:*", "community:*", "mentorship:*", "challenges:*", "messages:*", "analytics:*", "audit:read", "security:manage", "system:manage"],
  SUPER_ADMIN: ["*"],
};
