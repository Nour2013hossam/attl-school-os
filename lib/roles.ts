...
export const PERMISSION_MATRIX: Record<string, string[]> = {
  ...
  TEACHER: ["profile:*", "academics:read", "skills:read", "academics:teaching", "academics:gradebook", "academics:attendance", "academics:assignments", "academics:exams", "learning:read", "learning:manage", "learning:teaching", "messages:*", "mentorship:*"],
  ADMIN: ["admin.access", "users:*", "roles:*", "permissions:*", "results:*", "academics:*", "learning:*", "skills:read", "attl:*", "projects:*", "competitions:*", "events:*", "innovation:*", "community:*", "mentorship:*", "challenges:*", "messages:*", "analytics:*", "audit:read", "security:manage", "system:manage"],
  SUPER_ADMIN: ["*"],
};
